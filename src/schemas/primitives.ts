 ...
 * Base and Arbitrum One; v4 on Ethereum and Arbitrum One, the chains a working
 * v4 subgraph was found for. The list lib/chains/chains.ts holds, restated here so the
 * domain layer depends on nothing above it — a test holds the two together.
 */
export const READABLE_CHAIN_IDS = { v3: [1, 8453, 42161], v4: [1, 42161] } as const;
